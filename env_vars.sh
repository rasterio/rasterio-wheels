...
export BUILD_DEPENDS="setuptools oldest-supported-numpy cython~=3.0.2 wheel"
export TEST_DEPENDS="oldest-supported-numpy attrs pytest click mock boto3 packaging hypothesis wheel"
